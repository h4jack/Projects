...
*/
  ...
  function clearOther(s1,s2,s3,s4,a1 = 'block',a2 = 'none',a3 = 'none',a4 = 'none'){
    const q1 = document.querySelector(s1);
    const q2 = document.querySelector(s2);
    const q3= document.querySelector(s3);
    const q4= document.querySelector(s4);
    q1.style.display = a1;
    q2.style.display = a2;
    q3.style.display = a3;
    q4.style.display = a4;
    const riddleab = document.querySelector('.reveal-btn');
    riddleab.style.display = 'none';
  }
  
  //to show the heading to user
  function head(str){
    const head = document.querySelector('.heading');
    head.innerHTML = str;
  }
  
  //to put text under para tag
  function underPara(str){
    return '<p>'+str+'</p>';
  }
  ...
  */
  function showMeme() {
    ...
    head('Meme: ');
    clearOther('.meme','.quote','.riddle','.joke')
    meme.innerHTML = "<br><img src='"+randomMemeUrl+"' height='400' width='400'/>";
  ...
  */
  function showJoke() {
    ...
    head('Joke:')
    clearOther('.joke','.quote','.riddle','.meme')
    joke.innerHTML = underPara(randomJokeText);
  }
  ...
  */
  function showQuote() {
    ...
    clearOther('.quote','.meme','.riddle','.joke')
    const quote = document.querySelector('.quote');
    head('Quote: ')
    quote.innerHTML = underPara(randomQuote.quote)+underPara('Author: '+randomQuote.author);
  }
  ...
  */
  function showRiddle() {
    ...
    clearOther('.riddle','.quote','.meme','.joke')
    const riddleq = document.querySelector('.question');
    const riddlea = document.querySelector('.answer');
    head('Riddle: ');
    riddleq.innerHTML = randomRiddle.question;
    riddlea.style.display = 'none';
    riddlea.innerHTML = 'Answer: '+randomRiddle.answer;
    const riddleab = document.querySelector('.reveal-btn');
    riddleab.style.display = 'block';
  }
